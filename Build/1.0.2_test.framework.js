...
// include: /Applications/Unity/Hub/Editor/6000.5.11f1/PlaybackEngines/WebGLSupport/BuildTools/UserJsprePlaceholder.js


// end include: /Applications/Unity/Hub/Editor/6000.5.11f1/PlaybackEngines/WebGLSupport/BuildTools/UserJsprePlaceholder.js
// include: /Applications/Unity/Hub/Editor/6000.5.11f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/AnimationFrameRate.js
...
// end include: /Applications/Unity/Hub/Editor/6000.5.11f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/AnimationFrameRate.js
// include: /Applications/Unity/Hub/Editor/6000.5.11f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/Error.js
...
// end include: /Applications/Unity/Hub/Editor/6000.5.11f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/Error.js
// include: /Applications/Unity/Hub/Editor/6000.5.11f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/FullScreen.js
...
// end include: /Applications/Unity/Hub/Editor/6000.5.11f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/FullScreen.js
// include: /Applications/Unity/Hub/Editor/6000.5.11f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/IdbFs.js
if (typeof ENVIRONMENT_IS_PTHREAD === 'undefined' || !ENVIRONMENT_IS_PTHREAD) {
...
// end include: /Applications/Unity/Hub/Editor/6000.5.11f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/IdbFs.js
// include: /Applications/Unity/Hub/Editor/6000.5.11f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/MediaDevices.js
...
// end include: /Applications/Unity/Hub/Editor/6000.5.11f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/MediaDevices.js
// include: /Applications/Unity/Hub/Editor/6000.5.11f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/PlayerConnection.js
...
// end include: /Applications/Unity/Hub/Editor/6000.5.11f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/PlayerConnection.js
// include: /Applications/Unity/Hub/Editor/6000.5.11f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/SendMessage.js
...
// end include: /Applications/Unity/Hub/Editor/6000.5.11f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/SendMessage.js
// include: /Applications/Unity/Hub/Editor/6000.5.11f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/WebPlayerInitilization.js
...
// end include: /Applications/Unity/Hub/Editor/6000.5.11f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/WebPlayerInitilization.js
...
// Begin JS library code
  ...
  function _GetQueryParam(paramId) {
  ...
  function _SetCursorDefault() {
      try {
        // Same detection as above; allow pointer style toggling when fine pointer exists
        if (typeof window !== 'undefined') {
          var hasTouch = false;
          try {
            hasTouch = ('ontouchstart' in window) || (navigator && (navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0));
          } catch (_) {}
          var hasFinePointer = false;
          try {
            hasFinePointer = !!(window.matchMedia && window.matchMedia('(pointer: fine)').matches);
          } catch (_) {}
          var isTouchOnly = hasTouch && !hasFinePointer;
        ...
        if (typeof console !== 'undefined' && console && console.warn) {
          console.warn('SetCursorDefault failed:', e);
        }
      }
    }
  ...
  function _SetCursorPointer() {
      try {
        // Detect if device is truly touch-only. If it has a fine pointer (mouse/trackpad),
        // we should still show pointer even if touch is supported.
        if (typeof window !== 'undefined') {
          var hasTouch = false;
          try {
            hasTouch = ('ontouchstart' in window) || (navigator && (navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0));
        ...
        // Silently ignore to avoid breaking gameplay
        if (typeof console !== 'undefined' && console && console.warn) {
          console.warn('SetCursorPointer failed:', e);
        }
      }
    }

  function _UCSberContentError() {
          if (typeof window.ucsberContentError === 'function') window.ucsberContentError();
      }

  function _UCSberContentProgress(progress) {
          if (typeof window.ucsberContentProgress === 'function') window.ucsberContentProgress(progress);
      }

  function _UCSberContentReady() {
          if (typeof window.ucsberContentReady === 'function') window.ucsberContentReady();
      }

  var yandexMetrica = {
  yandexMetricaSend:function (eventName, eventData) {
        const eventDataJson = eventData === '' ? undefined : JSON.parse(eventData);
        //console.log('YANDEX_METRICA_INTERNAL_TEST_SENDING' + eventName + ' window:  ' + window.yandexMetricaCounterId)
        ym(51312949,'reachGoal',`${eventName}`)
      },
  };
...
var wasmImports = {
  ...
  /** @export */
  SetCursorDefault: _SetCursorDefault,
  /** @export */
  SetCursorPointer: _SetCursorPointer,
  /** @export */
  UCSberContentError: _UCSberContentError,
  /** @export */
  UCSberContentProgress: _UCSberContentProgress,
  /** @export */
  UCSberContentReady: _UCSberContentReady,
  /** @export */
